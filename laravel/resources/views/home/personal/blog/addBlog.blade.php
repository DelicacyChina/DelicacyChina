        ...
        <div class="mod_right">
            <div id="mod_location">
                <div class="mod_location clear">
                    <div class="left">
                        <a href="{{url('home/personal/blog/index')}}" title="回到我的日志" class="return"> </a>
                        发布新日志
                    </div>
                </div>
            </div>
            <form action="{{url('/home/personal/blog/addBlog')}}" id="J_form" enctype="multipart/form-data" method="post">
                {{csrf_field()}}
                <div class="mr_edit mr_edit_center clear">
                    <ul>
                        <li>
                            <label class="must">日志标题</label><br>
                            <input name="title" class="inputL" type="text" id="J_subject" >
                        </li>
                ...
                <div class="mr_edit mr_edit_fixed clear">
                    <input name="submit" value="发布日志" class="btn1" type="submit">
                </div>
            </form>
        </div><!-- 右侧结束 -->
    </div>
